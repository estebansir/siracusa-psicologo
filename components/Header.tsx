      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <a
            ...
            className="hidden lg:inline-flex items-center gap-2 px-5 py-2.5 rounded-md bg-teal-700 text-white font-medium text-sm hover:bg-teal-800 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700"
          >
