          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 rounded-md bg-teal-700 text-white font-medium hover:bg-teal-800 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700"
              >
            ...
            {/* Microcopy */}
            {microcopy && (
              <p className="microcopy text-sm text-gray-600">
                {microcopy}
              </p>
            )}
          </div>
